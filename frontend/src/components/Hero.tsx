      ...
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          ...
          <div>
            ...
            <Link
              href="https://drive.google.com/file/d/11lSvQOTd-mhsm70j3judUiu5RH2jxxA4/view?usp=drive_link"
        ...
        >
          <div className="rounded-full bg-[#181818] w-[250px] h-[250px] lg:w-[400px] lg:h-[400px] relative">
            <Image
              src={mee}
              alt="hero image"
              className="absolute transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 w-45 h-45 sm:w-64 sm:h-64 rounded-3xl "
              //   height={250}
              //   width={250}
            />
          </div>
